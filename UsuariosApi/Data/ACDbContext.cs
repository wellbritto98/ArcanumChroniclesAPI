    ...
    public class ACDbContext : IdentityDbContext<Usuario>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WayOfMagic>().HasData(
                new WayOfMagic { Id = 1, Name = "Arcana" },
                new WayOfMagic { Id = 2, Name = "Divina" },
                new WayOfMagic { Id = 3, Name = "Druídica" },
                new WayOfMagic { Id = 4, Name = "Sorrateira" }
                );

            // Seeding the TypeOfMagic table

            modelBuilder.Entity<TypeOfMagic>().HasData(
                new TypeOfMagic { Id = 1, Name = "Não-magico" },
                new TypeOfMagic { Id = 2, Name = "Magico" },
                new TypeOfMagic { Id = 3, Name = "Mestiço" }
                );

            // Seeding the Ability table

            modelBuilder.Entity<Ability>().HasData(
                new Ability { Id = 1, Name = "Natação" },
                new Ability { Id = 2, Name = "Acrobacia" },
                new Ability { Id = 3, Name = "Atletismo" },
                new Ability { Id = 4, Name = "Furtividade" },
                new Ability { Id = 5, Name = "Percepção" }
                );
